...
public interface UIConstants {
	...
	public final static String	ADD_MISSILE_LAUNCHER = "Add Missile Launcher";
	public final static String 	ADD_MISSILE_DESTRUCTOR = "Add Missile Destructor";
	public final static String 	ADD_LAUNCHER_DESTRUCTOR = "Add Launcher Destructor";
	public final static String 	LAUNCH_MISSILE = "Launche Missile";
	public final static String 	DESTRUCT_LAUNCHER = "Destruct a Launcher";
	public final static String 	DESTRUCT_MISSILE = "Destruct a Missile";
